 ...
 * <tbody><tr><td>status</td><td><code>(PENDING\|UPLOADING\|COMPLETE)</code></td><td>The status of the upload</td></tr><tr><td>percentage</td><td>Double</td><td>The 0-1 percentage of the file upload. If pending, this value should be 0.</td></tr></tbody>
 * </table>
 *
...
public class UploadStatusResponse extends BasicPayload {
    ...
    public UploadStatusResponse(int code, String message, String state, String status, double percentage) {
